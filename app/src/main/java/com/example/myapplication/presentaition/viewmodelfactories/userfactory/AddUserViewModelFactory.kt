...
class AddUserViewModelFactory(private val addUserUseCase: com.example.myapplication.domain.usecases.userusecase.AddUserUseCase): ViewModelProvider.Factory {
