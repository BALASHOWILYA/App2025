...
class MyApplication: Application() {
   ...
   val getUsersRepositoryImpl: com.example.myapplication.domain.repositories.userrepository.IGetUsersRepository by lazy { GetUsersRepositoryImpl(database) }
   val addUserRepositoryImpl: com.example.myapplication.domain.repositories.userrepository.IAddUserRepository by lazy { AddUserRepositoryImpl(database) }
   val getCoursesRepositoryImpl: com.example.myapplication.domain.repositories.courserepository.IGetCourseRepository by lazy{ GetCoursesRepositoryImpl(database) }
   val addCourseRepositoryImpl: com.example.myapplication.domain.repositories.courserepository.IAddCourseRepository by lazy{ AddCourseRepositoryImpl(database)}
}